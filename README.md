...
I’m a **Frontend Developer with 4 years of commercial experience** at **Sii Poland**.  
Before my current role, I worked as a **freelancer for around 1.5 years**.
I’ve been learning and working with frontend technologies for **over 8 years** in total.

At the moment, I’m **aspiring to a Senior Frontend Developer role**, while actively expanding my skills toward **full-stack development**, this is my main career goal for **2026**.

## Projects

Below you’ll find a list of my projects created **before landing my first job as a Junior Frontend Developer**.  
Please be kind when it comes to code quality, I’m fully aware that some of it hasn’t aged well 😄  
One of those projects still needs occasional fixing, which is a good reminder of how much I’ve learned since then.
...
### Frontend (my core expertise)
- **HTML5, CSS3, JavaScript (ES6+), TypeScript**
- **React**, **Next.js**
- Gatsby
- CSS Modules, **Styled Components**, **Sass / SCSS**
...
- AWS (EC2, S3, Lambda, RDS) — mainly from a frontend perspective, with solid understanding of how services integrate
- Vercel, Netlify
